...
public class DefectCommentComponent {
    ...
    public ResultHelperPo add(DefectComment defectComment) {
        if (null != defectComment.getId()) {
            return new ResultHelperPo(false, defectComment, "新增异常");
        }
        return new ResultHelperPo(true, defectCommentService.add(defectComment), "");
    }
